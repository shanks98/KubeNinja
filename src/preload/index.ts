...
const api: KnApi = {
  ...
  helm: {
    ...
    upgrade: (sessionId, name, namespace, chart, version, values) => ipcRenderer.invoke('helm:upgrade', sessionId, name, namespace, chart, version, values),
    install: (sessionId, name, namespace, chart, version, values) => ipcRenderer.invoke('helm:install', sessionId, name, namespace, chart, version, values),
    ...
    repoAdd: (name, url) => ipcRenderer.invoke('helm:repoAdd', name, url),
    repoRemove: (name) => ipcRenderer.invoke('helm:repoRemove', name),
    search: (term) => ipcRenderer.invoke('helm:search', term),
  },
  app: {
